...
public class SettingsController : ControllerBase
{
    ...
    public async Task<ActionResult<OperationResultDto>> UpdateAIScoringSettings([FromBody] AIScoringSettingsDto request, CancellationToken cancellationToken)
    {
        ...
        var settings = new AIScoringSettings
        {
            ...
            ScreenshotBlockAttemptThreshold = request.ScreenshotBlockAttemptThreshold,
            ScreenshotBlockReason = request.ScreenshotBlockReason,
            RequireAdminUnlockOnBlock = request.RequireAdminUnlockOnBlock,
    ...
    private static AIScoringSettingsDto ToDto(AIScoringSettings settings)
    {
        return new AIScoringSettingsDto
        {
            ...
            ScreenshotBlockAttemptThreshold = settings.ScreenshotBlockAttemptThreshold,
            ScreenshotBlockReason = settings.ScreenshotBlockReason,
            RequireAdminUnlockOnBlock = settings.RequireAdminUnlockOnBlock,
    ...
    private static PDFViewerSettings ToSettings(PDFViewerSettingsDto dto)
    {
        return new PDFViewerSettings
        {
            ...
            WatermarkRotationDegrees = dto.WatermarkRotationDegrees,
