...
Usuario -> Visor : Interacción y eventos
Visor -> Controller : Telemetría + IP + ViewerUserId
Controller -> Scoring : Solicitar SuspicionScore
Scoring -> Eventos : Calcular pesos y tasa
Scoring -> Comportamiento : Pedir RiskScore/anomalías
Comportamiento -> Perfil : Consultar/actualizar historial
Scoring -> Alertas : Registrar score/alerta
Scoring --> Controller : Score final normalizado
Controller --> Visor : Devolver score + recomendaciones
