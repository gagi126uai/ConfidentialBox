...
namespace ConfidentialBox.Infrastructure.Migrations
{
    ...
    [Migration("20251113024444_ChangesvariablesOptions")]
    partial class ChangesvariablesOptions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConfidentialBox.Core.Entities.SecurityAlertAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SecurityAlertActions");
                });
            ...
            modelBuilder.Entity("ConfidentialBox.Core.Entities.UserMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConfidentialBox.Core.Entities.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConfidentialBox.Core.Entities.SecurityAlertAction", b =>
                {
                    b.HasOne("ConfidentialBox.Core.Entities.SecurityAlert", "Alert")
                        .WithMany()
                        .HasForeignKey("AlertId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConfidentialBox.Core.Entities.ApplicationUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ConfidentialBox.Core.Entities.SharedFile", "TargetFile")
                        .WithMany()
                        .HasForeignKey("TargetFileId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ConfidentialBox.Core.Entities.ApplicationUser", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ConfidentialBox.Core.Entities.UserMessage", b =>
                {
                    b.HasOne("ConfidentialBox.Core.Entities.ApplicationUser", "Sender")
                        .WithMany()
